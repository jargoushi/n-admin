...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-b from-primary to-primary/90 text-primary-foreground shadow-sm hover:shadow-lg hover:shadow-primary/20 hover:from-primary/95 hover:to-primary/85',
        destructive:
          'bg-gradient-to-b from-destructive to-destructive/90 text-white shadow-sm hover:shadow-lg hover:shadow-destructive/20 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
        outline:
        ...
        secondary:
          'bg-gradient-to-b from-secondary to-secondary/90 text-secondary-foreground shadow-xs hover:shadow-sm hover:from-secondary/95 hover:to-secondary/85',
        ghost:
